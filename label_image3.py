...
if __name__ == "__main__":
    ...
    PATH_TO_TEST_IMAGES_DIR = 'C:\\Users\\Administrator\\Desktop\\汇总\\汇总\\toner_strip'
    class_name = os.path.split(PATH_TO_TEST_IMAGES_DIR)[-1]
    IMAGES = os.listdir(PATH_TO_TEST_IMAGES_DIR)
    if len(IMAGES) == 0:
        tf.logging.warning('No files found')
    model_file = \
        'K:\\YiTuClassify0409\\训练结果集合\\0428-87.6%_trainning20180426\\output_graph.pb'

    # 'F:\\Project\\Project\\YiTuClassify\\tmp\\output_graph.pb'
    graph = load_graph(model_file)
    # label_file = "F:\\Project\\Project\\YiTuClassify\\tmp\\output_labels.txt"
    label_file = "K:\\YiTuClassify0409\\训练结果集合\\0428-87.6%_trainning20180426\\output_labels.txt"
    input_height = 299
    input_width = 299
    input_mean = 0
    input_std = 255
